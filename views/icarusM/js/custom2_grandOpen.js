...
$(document).ready(function() {
    ...
    /*function checkBroswer(){*/        // 밑에 함수에서 사용하기 위해 전역변수로 풀어둡니다.
        ...
        if(name === 'Microsoft Internet Explorer' || agent.indexOf('trident') > -1 || agent.indexOf('edge/') > -1) {
            ...
            $('#sec1 #grandOpen h1').css({'background':'none', 'color':'#2f6dba'});
  ...
  /*  checkBroswer();*/
    ...
    function setMbImg() {
        if( $(window).outerWidth() <= 640 &&  $(window).outerWidth() > 414) {
            $('#sec1 .main-tit img').attr('src','https://file.valofe.com/Valofe_file/web/vfun/images/event/icarusm_gl/pre-register/grand_open/tit-launch.png');
