function setVideo() {
    ...
    if(  winWidth > 1024 ) {
        $('video').attr('poster', 'https://file.valofe.com/Valofe_file/web/vfun/images/event/icarusm_gl/pre-register/cbt/bg_main_cbt_pc.jpg');
        $('video').css('display', 'block');
        $('#main_video *').remove();
        $('#main_video').append('<source src="https://file.valofe.com/Valofe_file/web/vfun/video/event/icarusm_gl/pre-register/cbt/ICARUS_M_WebIntro_use_cbt.mp4" type="video/mp4"><source src="/static/video/event/icarusm_gl/pre-register/cbt/ICARUS_M_WebIntro_use_cbt.webm" type="video/webm" ');
        //myVideo.currentTime = 0;
        myVideo.play();
    } else {
        $('video').attr('poster', 'https://file.valofe.com/Valofe_file/web/vfun/images/event/icarusm_gl/pre-register/cbt/bg_main_cbt_mb.jpg');
...
$(document).ready(function() {
    ...
    /*function checkBroswer(){*/        // 밑에 함수에서 사용하기 위해 전역변수로 풀어둡니다.
        ...
        if(name === 'Microsoft Internet Explorer' || agent.indexOf('trident') > -1 || agent.indexOf('edge/') > -1) {
            ...
            $('.cbt-box .cbt-wrap .cbt-row h4').css({'background':'none', 'color':'#1c49c8 '}); // CBT grab ~
            $('.cbt-box .cbt-wrap .cbt-row h4:nth-child(2)').css({'background':'none', 'color':'#105fd6'}) // CBT AFTER ~
  ...
  /*  checkBroswer();*/
    ...
    calcSize();
    function setMbImg() {
        if( $(window).outerWidth() <= 640 &&  $(window).outerWidth() > 414) {
            $('#sec1 .main-tit img').attr('src','https://file.valofe.com/Valofe_file/web/vfun/images/event/icarusm_gl/pre-register/cbt/title_main_cbt_open.png');
            $('.cbt-box .cbt-wrap .cbt-row img.cbt-tit').attr('src','https://file.valofe.com/Valofe_file/web/vfun/images/event/icarusm_gl/pre-register/cbt/cbt_tit_mb.png');
        } else if(  $(window).outerWidth() <= 414 ) {
            $('#sec1 .main-tit img').attr('src','https://file.valofe.com/Valofe_file/web/vfun/images/event/icarusm_gl/pre-register/cbt/title_main_cbt_open_mb.png');
            $('.cbt-box .cbt-wrap .cbt-row img.cbt-tit').attr('src','https://file.valofe.com/Valofe_file/web/vfun/images/event/icarusm_gl/pre-register/cbt/cbt_tit_mb.png');
        }else {
            $('#sec1 .main-tit img').attr('src','https://file.valofe.com/Valofe_file/web/vfun/images/event/icarusm_gl/pre-register/cbt/title_main_cbt_open.png');
            $('.cbt-box .cbt-wrap .cbt-row img.cbt-tit').attr('src','https://file.valofe.com/Valofe_file/web/vfun/images/event/icarusm_gl/pre-register/cbt/cbt_tit.png');
        }
    }
    setMbImg();
    ...
    /********************* Floating Banner Start *********************/
     window.goSection = function(n) {
        ...
        if ( $(window).outerWidth() > 1024 ) {
            $("html,body").stop().animate({"scrollTop": $('#sec'+ n).offset().top - headerH}, 450);
        } else {
            if (n == 5) {
                n = 6;
            }
    ...
    function gage() {
        ...
        if (0 <= gageNum && gageNum < 10000 ) {
            ...
            var gage6 =/* (gageNum - 100000)  / 250;*/ 100
    ...
    function holeGageBar() {
        ...
        var widthAccum06 = $('#accum_06').width();
        $('#accum_hole').css({'width': widthAccum01 + widthAccum02 + widthAccum03 + widthAccum04 + widthAccum05  + widthAccum06 +'px'})
    ...
    $('.mb-class-wrap').slick({
        ...
        customPaging: function(slider, i) {
            ...
            return '<img src="./images/' + dotsName[i] + '.png" alt=" + dotsName[i] + ">';
        },
    });
